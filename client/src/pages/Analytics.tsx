    ...
    >
      {!selectedFile ? (
        <div className="bg-white shadow rounded-lg p-6 text-center">
          ...
          <Link to="/dashboard">
            <button className="px-4 py-2 text-sm font-medium text-white bg-primary-600 rounded-md hover:bg-primary-700 transition-colors flex items-center gap-2">Go to Data Ingestion</button>
          </Link>
        </div>
      ) : (
        <div className="space-y-6">
          ...
          <section className="bg-white shadow rounded-lg p-6">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <TrendingUp size={16} />{loading ? 'Predicting...' : 'Generate Predictions'}
              </button>
            </div>
            {error && (
